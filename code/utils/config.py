from utils.datasets import dacase2022_task3,dacase2023_task3
...
dataset_dict = {
    'dcase2022task3': dacase2022_task3,
    'dcase2023task3': dacase2023_task3,
}
...
def get_models(cfg, dataset, cuda, model_name=None):
    ...
    if(cfg['training']['model']=="MFF_EINV2"):
        logging.info('Model architectures:\n subnetwork:{}\n tfcm_layer:{}\n {}\n'.format(cfg['training']['subnetwork'], cfg['training']['tfcm_layer'], model))
    else:
        logging.info('Model architectures:\n{}\n'.format(model))
