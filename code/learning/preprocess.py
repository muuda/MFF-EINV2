        ...
        for idx, meta_file in iterator:
            ...
            for row in df:
                ...
                if frame_idx == prev_frame_idx:
                    ...
                    count = 1  # Reset the counter when a different frame_idx is encountered
                if count > 5:  # The row is added to filtered_df only when the counter is less than or equal to 5
                    continue
